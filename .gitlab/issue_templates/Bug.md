...
```
Paste relevant log entries from .n8n-ops/logs/n8n-ops.log
```
...
**Configuration File** (`~/.n8n-ops.yaml`):
```yaml
...
**Attempted Solutions**:
- [ ] Rebuilt CLI binary (`go build -o n8n-ops main.go`)
- [ ] Cleared local database (`.n8n-ops/database.sqlite`)
