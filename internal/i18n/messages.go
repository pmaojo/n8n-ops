...
var messages = map[Language]map[string]string{
	English: {
		...
		"branch_analysis_start":     "🌿 Starting branch workflow analysis...",
		"branch_info_title":         "🌿 BRANCH INFORMATION: %s",
		"all_branches_analysis":     "🌳 ALL BRANCHES ANALYSIS",
		"branch_comparison_title":   "🔍 BRANCH COMPARISON: %s vs %s",
		"monitor_starting":          "👁️ Starting workflow monitoring - %s environment",
		"monitor_check_interval":    "⏰ Check interval: %s",
		"monitor_failure_threshold": "🎯 Failure threshold: %d consecutive failures",
		"monitor_stop":              "⏹️ Press Ctrl+C to stop monitoring",
		"daemon_started":            "🤖 Daemon mode started - %s environment",
		"daemon_watching_files":     "👁️ Watching JSON files in ./workflows/%s/",
		"daemon_creating_backups":   "💾 Creating automatic backups before updating workflows",
		"dashboard_starting":        "🌐 Starting dashboard on port %d",
		"dashboard_environment":     "📊 Environment: %s",
		"dashboard_url":             "🔗 URL: http://localhost:%d",
	},
	Spanish: {
		...
		"branch_analysis_start":     "🌿 Iniciando análisis de ramas...",
		"branch_info_title":         "🌿 INFORMACIÓN DE RAMA: %s",
		"all_branches_analysis":     "🌳 ANÁLISIS DE TODAS LAS RAMAS",
		"branch_comparison_title":   "🔍 COMPARACIÓN DE RAMAS: %s vs %s",
		"monitor_starting":          "👁️ Iniciando monitoreo de workflows - %s",
		"monitor_check_interval":    "⏰ Intervalo de verificación: %s",
		"monitor_failure_threshold": "🎯 Umbral de fallos: %d fallos consecutivos",
		"monitor_stop":              "⏹️ Presiona Ctrl+C para detener el monitoreo",
		"daemon_started":            "🤖 Modo daemon iniciado - %s",
		"daemon_watching_files":     "👁️ Monitoreando archivos JSON en ./workflows/%s/",
		"daemon_creating_backups":   "💾 Creando backups automáticos antes de actualizar workflows",
		"dashboard_starting":        "🌐 Iniciando dashboard en puerto %d",
		"dashboard_environment":     "📊 Ambiente: %s",
		"dashboard_url":             "🔗 URL: http://localhost:%d",
	},
}
...
// PrintlnKey prints the translation for the given key with a newline.
func PrintlnKey(key string) {
	fmt.Println(T(key))
}

// PrintfKey prints the formatted translation for the given key.
func PrintfKey(key string, args ...interface{}) {
